...
deploy = dict(
    gpu_id='0',
    transforms=[
        # dict(type='Resize', height=160, width=320,
        #      interpolation='bilinear', p=1),
        dict(type='PadorResize', min_height=160,
             min_width=320, border_mode='constant',
             value=0),
...
train = dict(
    data=dict(
        train=dict(
            ...
            transforms=[
                ...
                dict(type='MakeShrinkMap', ratios=[0.4], max_shr=20,
                     min_text_size=8, p=1),
            ...
            dataloader=dict(type='BaseDataloader', batch_size=batch_size,
    ...
    save_best=True,
    resume=dict(checkpoint='./workdir/st_ocd/iter100000.pth',
